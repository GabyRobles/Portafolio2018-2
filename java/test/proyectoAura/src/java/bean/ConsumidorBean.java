...
public class ConsumidorBean {
   ...
   public void create(String nombre,String apellido,String rut,Date fechaNac,String correo,String contrasena,Integer puntaje,String telefono,Character envOferta){
   ...
   public Consumidor findByCorreo(String Correo){
